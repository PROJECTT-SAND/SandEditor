...
export default function Objects() {
  const [objectDatas, setObjectDatas] = useState<{ [uuid: string]: Object }>({
    ...
    "3": { name: 'Tlqkf2', type: ObjType.object, isHidden: false, parentUUID: 1, UUID: 3 },
    "4": { name: 'Chr1', kind: ObjKind.object, isHidden: false, parentUUID: 1, UUID: 4 },
    "5": { name: 'Head', kind: ObjKind.object, isHidden: false, parentUUID: 4, UUID: 5 },
    "6": { name: 'arm', kind: ObjKind.object, isHidden: false, parentUUID: 4, UUID: 6 },
    "7": { name: 'body', kind: ObjKind.object, isHidden: false, parentUUID: 4, UUID: 7 },
  });

  const objectTree: objectTreeNode[] = [{
    uuid: "1",
    isopened: false,
    children: [
      {
  ...
  if (objectData == OBJECT_TYPE.Scene) {
    icon = folderIcon
  }
